                                ...
                                <tbody>
                                    <?php foreach ($data['transaksi'] as $tk) : ?>
                                        <tr>
                                            ...
                                            <td> <?php if ($tk['status_rental'] == 6) { ?>
                                                    <a href="<?= BASEURL; ?>/pelanggan/pembayaran/<?= $tk['id_rental'] ?>" class="btn btn-success">Rental Selesai</a>
                                                <?php } elseif ($tk['status_rental'] == 5) { ?>
                                                    <a href="<?= BASEURL; ?>/pelanggan/pembayaran/<?= $tk['id_rental'] ?>" class="btn btn-outline-warning">Sedang Rental</a>
                                                <?php } elseif ($tk['status_rental'] == 2) { ?>
                                                    <a href="<?= BASEURL; ?>/pelanggan/pembayaran/<?= $tk['id_rental'] ?>" class="btn btn-outline-primary">Belum Diambil</a>
                                                <?php } else { ?>
