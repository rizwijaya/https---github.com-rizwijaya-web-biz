                                        ...
                                        <div class="icons"> <button type="button" class="btn btn-danger icons" data-toggle="modal" data-target="#update_modal<?= $dt['id_mobil']; ?>" <?php if ($dt['status'] == 1) {
                                                                                                                                                                                            ...
                                                                                                                                                                                            echo 'disabled ><i class="icon icon-cloud-download mr-1"></i> Tidak Tersedia';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            echo 'disabled ><i class="icon icon-cloud-download mr-1"></i> Tidak Tersedia';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            echo 'disabled ><i class="icon icon-cloud-download mr-1"></i> Tidak Tersedia';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        } ?></a> <?php } ?> <a href="whatsapp://send?text=Sewa <?= $dt['merk'] ?> di Bizcar Rental, nikmati perjalanan nyaman dan aman dengan kendaraan impian. <?= BASEURL; ?>/home/detail/<?= $dt['id_mobil'] ?>" class="btn btn-info icons"><i class="icon icon-share mr-1"></i> Share Ad</a>
                                     </div>
                                </div>
                            </div>
                        </div>
